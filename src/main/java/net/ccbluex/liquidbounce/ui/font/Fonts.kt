...
object Fonts : MinecraftInstance {
    ...
    fun loadFonts() {
        ...
        val time = measureTimeMillis {
            ...
            fontLarge = register(FontInfo("Roboto Medium", size = 52), getLBPPFontFromFile("Roboto-Medium.ttf", 52).asGameFontRenderer())

            fontLarge = register(FontInfo("Roboto Medium", size = 30), getLBPPFontFromFile("Roboto-Medium.ttf", 30).asGameFontRenderer())

            fontTahomaSmall = TTFFontRenderer(getLBPPFontFromFile("Tahoma.ttf", 11))


            font35 = register(FontInfo("Roboto Medium", size = 35), getLBPPFontFromFile("Roboto-Medium.ttf", 35).asGameFontRenderer())

            font40 = register(FontInfo("Roboto Medium", size = 40), getLBPPFontFromFile("Roboto-Medium.ttf", 40).asGameFontRenderer())
    ...
    private fun getLBPPFontFromFileOrNull(file: String, size: Int): Font? = try {
        val resourcePath = "/assets/minecraft/${CLIENT_NAME.lowercase()}/lbppfonts/$file"
        val inputStream = Fonts::class.java.getResourceAsStream(resourcePath)
    ...
    private fun getLBPPFontFromFile(file: String, size: Int): Font =
        getLBPPFontFromFileOrNull(file, size)?: Font("default", Font.PLAIN, size)

    ...
    public int DisplayFontWidths(String str, CFontRenderer font) {
        ...
        for (int iF = 0; iF < str.length(); ++iF) {
            ...
            if (s.contains("§") && iF + 1 <= str.length()) {
                ...
                x += Fonts.fontSemibold35.getStringWidth(s);
            }
        }
        return x + 5;
    }
    ...
    public static float DisplayFont(String str, float x, float y, int color, boolean shadow, CFontRenderer font) {
        ...
        for (int iF = 0; iF < str.length(); ++iF) {
            ...
            if (s.contains("§") && iF + 1 <= str.length()) {
                ...
                Fonts.fontSemibold35.drawString(s, x + 1.5f, y + 2, new Color(0, 0, 0, 50).getRGB());
                Fonts.fontSemibold35.drawString(s, x + 0.5f, y + 1, color);
                x += (float) Fonts.fontSemibold35.getStringWidth(s);
            }
        }
        return x;
    }

...
import net.ccbluex.liquidbounce.Lizz.CLIENT_CLOUD
import net.ccbluex.liquidbounce.Lizz.CLIENT_NAME
import net.ccbluex.liquidbounce.Lizz.MINECRAFT_VERSION
import net.ccbluex.liquidbounce.Lizz.clientVersionText
...
object ClientRichPresence : Configurable("DiscordRPC"), MinecraftInstance, Listenable {
    ...
    fun setup() {
        try {
            ...
            ipcClient = IPCClient(1431619192536170596).apply {
    ...
    fun update() {
        ...
        val builder = RichPresence.Builder().apply {
            ...
            assets["logo"]?.let {
                setLargeImage(it, "MC $MINECRAFT_VERSION - $CLIENT_NAME $clientVersionText")
            }
